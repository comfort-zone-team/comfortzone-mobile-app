...
const EmptyView = () => (
  <View style={styles.emptyView}>
    ...
    />
    <Text style={styles.emptyViewText}>You have not hired any orders yet.</Text>
  </View>
);
        ...
        <TouchableOpacity onPress={() => onOrderSelected(services[index])}>
          <View key={service._id} style={styles.serviceView}>
            ...
            <View style={styles.serviceContent}>
              ...
              <WhiteSpace />
              <Text category='c1'>
                Status: {isCompleted ? 'Completed' : 'Cancelled by Worker'}
              </Text>
            </View>
          </View>
        </TouchableOpacity>
...
export default function MyHiringHistory({ navigation }) {
  ...
  return (
    <SafeAreaView>
      <TopNavigation
        ...
        subtitle="History of services you've hired"
        accessoryLeft={(props) => (
          <TopNavigationAction
            {...props}
